...
namespace Collision_Avoidance_Core
{
    public partial class frmMain : Form
    {
        ...
        void run_TFdetector()
        {
            TFDetectCore.TFDetect.Init(SettingsHolder.Instance.ModelFile, SettingsHolder.Instance.LabellFile);
            ...
            while (!cancelEvent.IsCancellationRequested)
            {
                ...
                {
                    TFDetectCore.Results resultsFromTF = null;
                    var sw = Stopwatch.StartNew();
                    TFDetectCore.TFDetect.Predict(grabbedImage.ToBitmap(), ref resultsFromTF);
                    sw.Stop();
